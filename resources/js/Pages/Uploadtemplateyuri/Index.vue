...
const submit = () => {
    if (isEditing.value) {
        ...
        router.post(
            route("templateyuri.update", editingId.value),
            {
        ...
        form.post(route("templateyuri.store"), {
            forceFormData: true,
            onSuccess: () => {
...
const downloadFile = (id) => {
    window.location.href = route("templateyuri.download", id);
};
...
const executeDelete = () => {
    router.delete(route("templateyuri.destroy", reportToDelete.value.id), {
        preserveScroll: true,
        onSuccess: () => {
...
const resetFilter = () => {
    ...
    router.get(route("templateyuri.index"));
};
...
watch([selectedAgent, selectedPeriod], ([agent, period]) => {
    console.log("WATCH");
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <button
                                @click="resetFilter"
                                class="px-4 bg-gray-500 text-white rounded-md"
                            >
                                Reset
                            </button>
                        </div>
